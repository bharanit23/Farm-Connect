...
# ── Localized command mappings (Tamil/Hindi → English canonical) ──────────────
LOCALIZED_COMMANDS = {
    # Tamil
    "வேலை போடு":         "POST JOB",
    "என் வேலைகள்":       "MY JOBS",
    ...
    "ரத்து":              "CANCEL",
    "மதிப்பிடு":         "RATE",
    "வேலை முடிந்தது":    "JOB DONE",
    "திறன் மாற்று":      "UPDATE SKILL",
    "உபகரணம் வாடகை":    "RENT EQUIPMENT",
    "உபகரணம் பார்":      "VIEW EQUIPMENT",
    "என் உபகரணம்":       "MY EQUIPMENT",
    "உபகரணம் பதிவு":     "BOOK EQUIPMENT",
    "திட்டங்கள்":        "SUBSIDIES",
    "என் சுயவிவரம்":     "MY PROFILE",
    "வேலை வரலாறு":       "JOB HISTORY",
    "இன்று":             "TODAY",
    "மீண்டும் அழை":      "REHIRE",
    "என் நாட்கள்":       "MY DAYS",
    "வரவில்லை":          "NO SHOW",
...
T = {
    ...
    # Inline job-card labels used inside loop bodies
    "lbl_work":       "Work",
    "lbl_date":       "Date",
    "lbl_labourer":   "Labourer",
    "lbl_farmer":     "Farmer",
    "lbl_status":     "Status",
...
SUBSIDY_SCHEMES = [
    {
        ...
        "short_ta":     "விவசாயிகளுக்கு ஆண்டுக்கு ₹6,000 நேரடி வருமான உதவி",
        "short_hi":     "किसानों को प्रति वर्ष ₹6,000 की प्रत्यक्ष आय सहायता",
        ...
        "eligibility_ta": "வருமான வரி செலுத்துவோர், அரசு ஊழியர்கள் போன்றோரை தவிர அனைத்து நில உரிமையாளர் விவசாய குடும்பங்கள்.",
        "eligibility_hi": "सभी भूधारक किसान परिवार (आयकर दाताओं, सरकारी कर्मचारियों जैसी श्रेणियों को छोड़कर)।",
        "benefit":      "₹6,000 per year, paid in 3 installments of ₹2,000 directly to bank account.",
        "benefit_ta":   "ஆண்டுக்கு ₹6,000, ₹2,000 வீதம் 3 தவணைகளில் நேரடியாக வங்கி கணக்கில் செலுத்தப்படும்.",
        "benefit_hi":   "प्रति वर्ष ₹6,000, ₹2,000 की 3 किश्तों में सीधे बैंक खाते में।",
        ...
        "how_to_apply_ta": "pmkisan.gov.in இல் ஆன்லைனில் விண்ணப்பிக்கவும் அல்லது ஆதார், நில ஆவணங்கள், வங்கி கணக்து விவரங்களுடன் அருகிலுள்ள CSC மையத்திற்கு செல்லவும்.",
        "how_to_apply_hi": "pmkisan.gov.in पर ऑनलाइन आवेदन करें या आधार, भूमि रिकॉर्ड और बैंक विवरण के साथ नजदीकी CSC केंद्र जाएँ।",
    ...
    },
    {
        ...
        "short_ta":     "கரீஃப் 2025 பருவத்திற்கான பயிர் காப்பீடு",
        "short_hi":     "खरीफ 2025 मौसम के लिए फसल बीमा",
        "eligibility":  "All farmers growing notified crops in notified areas, including sharecroppers and tenant farmers.",
        "eligibility_ta": "குறிப்பிடப்பட்ட பகுதிகளில் அறிவிக்கப்பட்ட பயிர்களை பயிரிடும் அனைத்து விவசாயிகள், குத்தகை விவசாயிகள் உட்பட.",
        "eligibility_hi": "अधिसूचित क्षेत्रों में अधिसूचित फसलें उगाने वाले सभी किसान, बटाईदार और किराये के किसान सहित।",
        "benefit":      "Low premium (2% of sum insured) crop insurance covering losses from natural calamities, pests, and diseases.",
        "benefit_ta":   "இயற்கை சேதம், பூச்சி, நோய்களால் ஏற்படும் இழப்புகளை உள்ளடக்கிய குறைந்த பிரீமியம் (காப்பீட்டு தொகையில் 2%) பயிர் காப்பீடு.",
        "benefit_hi":   "प्राकृतिक आपदाओं, कीटों और रोगों से होने वाले नुकसान को कवर करने वाला कम प्रीमियम (बीमित राशि का 2%) फसल बीमा।",
        "how_to_apply": "Apply through your bank, CSC, or pmfby.gov.in before 31 July 2025 (Kharif cutoff).",
        "how_to_apply_ta": "31 ஜூலை 2025க்கு முன் உங்கள் வங்கி, CSC அல்லது pmfby.gov.in மூலம் விண்ணப்பிக்கவும்.",
        "how_to_apply_hi": "31 जुलाई 2025 से पहले अपने बैंक, CSC या pmfby.gov.in के माध्यम से आवेदन करें।",
    ...
    },
    {
        ...
        "short_ta":     "ரபி 2025–26 பருவத்திற்கான பயிர் காப்பீடு",
        "short_hi":     "रबी 2025–26 मौसम के लिए फसल बीमा",
        "eligibility":  "All farmers growing notified Rabi crops.",
        "eligibility_ta": "அறிவிக்கப்பட்ட ரபி பயிர்களை பயிரிடும் அனைத்து விவசாயிகள்.",
        "eligibility_hi": "अधिसूचित रबी फसलें उगाने वाले सभी किसान।",
        "benefit":      "Low premium (1.5% of sum insured) crop insurance covering losses from natural calamities.",
        "benefit_ta":   "இயற்கை சேதங்களால் ஏற்படும் இழப்புகளை உள்ளடக்கிய குறைந்த பிரீமியம் (காப்பீட்டு தொகையில் 1.5%) காப்பீடு.",
        "benefit_hi":   "प्राकृतिक आपदाओं से होने वाले नुकसान को कवर करने वाला कम प्रीमियम (बीमित राशि का 1.5%) बीमा।",
        "how_to_apply": "Apply through your bank, CSC, or pmfby.gov.in before 31 December 2025 (Rabi cutoff).",
        "how_to_apply_ta": "31 டிசம்பர் 2025க்கு முன் உங்கள் வங்கி, CSC அல்லது pmfby.gov.in மூலம் விண்ணப்பிக்கவும்.",
        "how_to_apply_hi": "31 दिसंबर 2025 से पहले अपने बैंक, CSC या pmfby.gov.in के माध्यम से आवेदन करें।",
    ...
    },
    {
        ...
        "short_ta":     "குறைந்த வட்டியில் விவசாய தேவைகளுக்கு எளிய கடன் வசதி",
        "short_hi":     "कम ब्याज पर खेती की जरूरतों के लिए आसान ऋण सुविधा",
        "eligibility":  "Farmers, tenant farmers, sharecroppers, and self-help group members.",
        "eligibility_ta": "விவசாயிகள், குத்தகை விவசாயிகள், பங்கு விவசாயிகள் மற்றும் சுயஉதவி குழு உறுப்பினர்கள்.",
        "eligibility_hi": "किसान, किराये के किसान, बटाईदार और स्वयं सहायता समूह के सदस्य।",
        "benefit":      "Short-term loans at subsidized interest rates (4–7%) for crop production, equipment, and allied activities.",
        "benefit_ta":   "பயிர் உற்பத்தி, உபகரணங்கள் மற்றும் தொடர்புடைய நடவடிக்கைகளுக்கு மானிய வட்டி விகிதத்தில் (4–7%) குறுகிய கால கடன்.",
        "benefit_hi":   "फसल उत्पादन, उपकरण और संबद्ध गतिविधियों के लिए रियायती ब्याज दरों (4–7%) पर अल्पकालिक ऋण।",
        "how_to_apply": "Apply at any nearby bank branch with land documents and identity proof.",
        "how_to_apply_ta": "நில ஆவணங்கள் மற்றும் அடையாள சான்றுடன் அருகிலுள்ள வங்கி கிளையில் விண்ணப்பிக்கவும்.",
        "how_to_apply_hi": "भूमि दस्तावेज और पहचान प्रमाण के साथ किसी भी नजदीकी बैंक शाखा में आवेदन करें।",
    ...
    },
    {
        ...
        "short_ta":     "இலவச மண் பரிசோதனை மற்றும் பயிர்வாரியான ஊட்டச்சத்து ஆலோசனை",
        "short_hi":     "मुफ्त मिट्टी परीक्षण और फसलवार पोषक तत्व सलाह",
        ...
        "benefit_ta":   "உள்ளீட்டு செலவுகளை குறைக்க பயிர்வாரியான உர மற்றும் ஊட்டச்சத்து பரிந்துரைகளுடன் 2 ஆண்டுகளுக்கு ஒருமுறை இலவச மண் பரிசோதனை.",
        "benefit_hi":   "इनपुट लागत घटाने के लिए फसलवार उर्वरक और पोषक तत्व सिफारिशों के साथ हर 2 साल में मुफ्त मिट्टी परीक्षण।",
        "how_to_apply": "Contact your local Krishi Vigyan Kendra (KVK) or agriculture department office to get your soil tested.",
        "how_to_apply_ta": "மண் பரிசோதனை செய்ய உங்கள் உள்ளூர் கிருஷி விஞ்ஞான் கேந்திரம் (KVK) அல்லது வேளாண்மை துறை அலுவலகத்தை தொடர்பு கொள்ளவும்.",
        "how_to_apply_hi": "मिट्टी परीक्षण के लिए अपने स्थानीय कृषि विज्ञान केन्द्र (KVK) या कृषि विभाग कार्यालय से संपर्क करें।",
    ...
    },
    {
        ...
        "short_ta":     "100 நாட்கள் உத்தரவாதமான கிராமப்புற வேலைவாய்ப்பு",
        "short_hi":     "100 दिन की गारंटीकृत ग्रामीण रोजगार",
        "eligibility":  "Any rural household willing to do unskilled manual work (relevant for labourers).",
        "eligibility_ta": "திறனற்ற கைமுறை வேலை செய்ய தயாரான எந்த கிராமப்புற குடும்பமும் (தொழிலாளர்களுக்கு பொருந்தும்).",
        "eligibility_hi": "कोई भी ग्रामीण परिवार जो अकुशल शारीरिक कार्य करने के इच्छुक हों (मजदूरों के लिए प्रासंगिक)।",
        "benefit":      "Guaranteed 100 days of wage employment per year at the notified minimum wage.",
        "benefit_ta":   "அறிவிக்கப்பட்ட குறைந்தபட்ச ஊதியத்தில் ஆண்டுக்கு 100 நாட்கள் ஊதிய வேலைவாய்ப்பு உத்தரவாதம்.",
        "benefit_hi":   "अधिसूचित न्यूनतम वेतन पर प्रति वर्ष 100 दिन के वेतन रोजगार की गारंटी।",
        "how_to_apply": "Register at your local Gram Panchayat to get a Job Card, then apply for work as needed.",
        "how_to_apply_ta": "வேலை அட்டை பெற உங்கள் உள்ளூர் கிராம பஞ்சாயத்தில் பதிவு செய்யவும், பின்னர் தேவைக்கேற்ப வேலைக்கு விண்ணப்பிக்கவும்.",
        "how_to_apply_hi": "जॉब कार्ड पाने के लिए अपनी स्थानीय ग्राम पंचायत में पंजीकरण करें, फिर आवश्यकतानुसार काम के लिए आवेदन करें।",
    ...
    },
    {
        ...
        "short_ta":     "சொட்டு நீர்ப்பாசனம் மற்றும் தெளிப்பு பாசன அமைப்புகளுக்கு மானியம்",
        "short_hi":     "ड्रिप और स्प्रिंकलर सिंचाई प्रणालियों पर सब्सिडी",
        "eligibility":  "All farmers; SC/ST and small/marginal farmers get higher subsidy (55%).",
        "eligibility_ta": "அனைத்து விவசாயிகளும்; SC/ST மற்றும் சிறு/குறு விவசாயிகளுக்கு அதிக மானியம் (55%).",
        "eligibility_hi": "सभी किसान; SC/ST और लघु/सीमांत किसानों को अधिक सब्सिडी (55%)।",
        "benefit":      "55% subsidy for small/marginal farmers, 45% for others on drip and sprinkler irrigation systems.",
        "benefit_ta":   "சொட்டு நீர் மற்றும் தெளிப்பு பாசன அமைப்புகளில் சிறு/குறு விவசாயிகளுக்கு 55% மானியம், மற்றவர்களுக்கு 45%.",
        "benefit_hi":   "ड्रिप और स्प्रिंकलर सिंचाई प्रणालियों पर लघु/सीमांत किसानों को 55%, अन्य को 45% सब्सिडी।",
        "how_to_apply": "Apply through your State Agriculture Department or pmksy.gov.in with land and Aadhaar details.",
        "how_to_apply_ta": "நில மற்றும் ஆதார் விவரங்களுடன் உங்கள் மாநில வேளாண்மை துறை அல்லது pmksy.gov.in மூலம் விண்ணப்பிக்கவும்.",
        "how_to_apply_hi": "भूमि और आधार विवरण के साथ अपने राज्य कृषि विभाग या pmksy.gov.in के माध्यम से आवेदन करें।",
    ...
    },
    {
        ...
        "short_ta":     "முக்கிய பயிர்களுக்கு இலவச சான்றளிக்கப்பட்ட விதைகள் மற்றும் உள்ளீட்டு ஆதரவு",
        "short_hi":     "प्रमुख फसलों के लिए मुफ्त प्रमाणित बीज और इनपुट सहायता",
        "eligibility":  "Farmers in notified districts growing rice, wheat, pulses, or coarse cereals.",
        "eligibility_ta": "அறிவிக்கப்பட்ட மாவட்டங்களில் நெல், கோதுமை, பருப்பு வகைகள் அல்லது கரடுமுரடான தானியங்களை பயிரிடும் விவசாயிகள்.",
        "eligibility_hi": "अधिसूचित जिलों में चावल, गेहूं, दालें या मोटे अनाज उगाने वाले किसान।",
        "benefit":      "Free/subsidised certified seeds, farm machinery, training, and demonstrations.",
        "benefit_ta":   "இலவச/மானிய சான்றளிக்கப்பட்ட விதைகள், வேளாண் இயந்திரங்கள், பயிற்சி மற்றும் விளக்கக்காட்சிகள்.",
        "benefit_hi":   "मुफ्त/सब्सिडी प्रमाणित बीज, कृषि मशीनरी, प्रशिक्षण और प्रदर्शन।",
        "how_to_apply": "Contact your Block Agriculture Officer or local Krishi Vigyan Kendra (KVK).",
        "how_to_apply_ta": "உங்கள் தொகுதி வேளாண்மை அதிகாரி அல்லது உள்ளூர் கிருஷி விஞ்ஞான் கேந்திரத்தை (KVK) தொடர்பு கொள்ளவும்.",
        "how_to_apply_hi": "अपने प्रखंड कृषि अधिकारी या स्थानीय कृषि विज्ञान केन्द्र (KVK) से संपर्क करें।",
    ...
    },
    {
        ...
        "short_ta":     "வறட்சியால் பாதிக்கப்பட்ட தமிழ்நாடு விவசாயிகளுக்கு ஏக்கருக்கு ₹2,000 ஒருமுறை நிவாரணம்",
        "short_hi":     "सूखा प्रभावित TN किसानों को प्रति एकड़ ₹2,000 एकमुश्त राहत",
        "eligibility":  "Farmers in Tamil Nadu districts declared drought-affected for 2024–25 season.",
        "eligibility_ta": "2024–25 பருவத்தில் வறட்சி பாதிக்கப்பட்டதாக அறிவிக்கப்பட்ட தமிழ்நாடு மாவட்டங்களில் உள்ள விவசாயிகள்.",
        "eligibility_hi": "2024–25 मौसम के लिए सूखाग्रस्त घोषित तमिलनाडु जिलों के किसान।",
        "benefit":      "₹2,000 per acre (up to 5 acres) direct bank transfer to eligible farmers.",
        "benefit_ta":   "தகுதியுள்ள விவசாயிகளுக்கு ஏக்கருக்கு ₹2,000 (அதிகபட்சம் 5 ஏக்கர்) நேரடி வங்கி மாற்றம்.",
        "benefit_hi":   "पात्र किसानों को प्रति एकड़ ₹2,000 (अधिकतम 5 एकड़) सीधे बैंक हस्तांतरण।",
        ...
        "how_to_apply_ta": "30 செப்டம்பர் 2025க்கு முன் பட்டா/சிட்டா மற்றும் வங்கி பாஸ்புக்குடன் உங்கள் கிராம நிர்வாக அலுவலகத்தில் (VAO) விண்ணப்பிக்கவும்.",
        "how_to_apply_hi": "30 सितंबर 2025 से पहले पट्टा/चिट्टा और बैंक पासबुक के साथ अपने ग्राम प्रशासनिक कार्यालय (VAO) में आवेदन करें।",
    ...
    },
    {
        ...
        "short_ta":     "இந்தியா முழுவதும் வாங்குபவர்களுக்கு ஆன்லைனில் நேரடியாக பயிர்களை விற்கவும்",
        "short_hi":     "पूरे भारत में खरीदारों को ऑनलाइन सीधे फसल बेचें",
        "eligibility":  "All farmers with produce registered at a linked APMC mandi.",
        "eligibility_ta": "இணைக்கப்பட்ட APMC மண்டியில் பதிவு செய்யப்பட்ட விளைபொருட்களைக் கொண்ட அனைத்து விவசாயிகளும்.",
        "eligibility_hi": "लिंक्ड APMC मंडी में पंजीकृत उपज वाले सभी किसान।",
        "benefit":      "Access to buyers across India, transparent online bidding, and direct bank payment — better prices, no middlemen.",
        "benefit_ta":   "இந்தியா முழுவதும் வாங்குபவர்களுக்கான அணுகல், வெளிப்படையான ஆன்லைன் ஏலம், நேரடி வங்கி கட்டணம் — சிறந்த விலைகள், இடைத்தரகர்கள் இல்லை.",
        "benefit_hi":   "पूरे भारत में खरीदारों तक पहुंच, पारदर्शी ऑनलाइन बोली और सीधा बैंक भुगतान — बेहतर दाम, बिचौलिए नहीं।",
        "how_to_apply": "Register at enam.gov.in or through your local APMC/mandi office with Aadhaar and bank details.",
        "how_to_apply_ta": "ஆதார் மற்றும் வங்கி விவரங்களுடன் enam.gov.in இல் அல்லது உங்கள் உள்ளூர் APMC/மண்டி அலுவலகம் மூலம் பதிவு செய்யவும்.",
        "how_to_apply_hi": "आधार और बैंक विवरण के साथ enam.gov.in पर या अपने स्थानीय APMC/मंडी कार्यालय के माध्यम से पंजीकरण करें।",
    ...
    },
    {
        ...
        "short_ta":     "வேளாண் சேமிப்பு மற்றும் பதப்படுத்தலுக்கு குறைந்த வட்டி கடன்கள்",
        "short_hi":     "कृषि भंडारण और प्रसंस्करण के लिए कम ब्याज ऋण",
        "eligibility":  "Farmers, FPOs, PACS, SHGs, agri-entrepreneurs for post-harvest infrastructure.",
        "eligibility_ta": "அறுவடை பிந்தைய கட்டமைப்புக்கான விவசாயிகள், FPO, PACS, SHG, வேளாண் தொழில்முனைவோர்.",
        "eligibility_hi": "फसल कटाई के बाद बुनियादी ढांचे के लिए किसान, FPO, PACS, SHG, कृषि उद्यमी।",
        "benefit":      "Loans up to ₹2 crore at 3% interest subsidy for warehouses, cold storage, processing units.",
        "benefit_ta":   "கிடங்குகள், குளிர் சேமிப்பு, பதப்படுத்தல் அலகுகளுக்கு 3% வட்டி மானியத்தில் ₹2 கோடி வரை கடன்.",
        "benefit_hi":   "गोदामों, शीत भंडारण, प्रसंस्करण इकाइयों के लिए 3% ब्याज सब्सिडी पर ₹2 करोड़ तक ऋण।",
        "how_to_apply": "Apply through any scheduled bank or at agriinfra.dac.gov.in with project report and land documents.",
        "how_to_apply_ta": "திட்ட அறிக்கை மற்றும் நில ஆவணங்களுடன் எந்த திட்டமிட்ட வங்கியிலும் அல்லது agriinfra.dac.gov.in இல் விண்ணப்பிக்கவும்.",
        "how_to_apply_hi": "परियोजना रिपोर्ट और भूमि दस्तावेजों के साथ किसी भी अनुसूचित बैंक या agriinfra.dac.gov.in पर आवेदन करें।",
    ...
    },
    {
        ...
        "short_ta":     "வாழை, தக்காளி, வெங்காயம் (தமிழ்நாடு) பயிர் காப்பீடு",
        "short_hi":     "केला, टमाटर, प्याज (TN) के लिए फसल बीमा",
        "eligibility":  "Tamil Nadu farmers growing banana, tomato, onion, or other notified horticultural crops.",
        "eligibility_ta": "வாழை, தக்காளி, வெங்காயம் அல்லது அறிவிக்கப்பட்ட தோட்டக்கலை பயிர்களை பயிரிடும் தமிழ்நாடு விவசாயிகள்.",
        "eligibility_hi": "केला, टमाटर, प्याज या अन्य अधिसूचित बागवानी फसलें उगाने वाले तमिलनाडु के किसान।",
        "benefit":      "5% premium cap, covers crop loss from drought, flood, pests, and unseasonal rain.",
        "benefit_ta":   "5% பிரீமியம் வரம்பு, வறட்சி, வெள்ளம், பூச்சி மற்றும் பருவமற்ற மழையால் ஏற்படும் பயிர் இழப்பை உள்ளடக்குகிறது.",
        "benefit_hi":   "5% प्रीमियम सीमा, सूखा, बाढ़, कीट और बेमौसम बारिश से फसल नुकसान को कवर करता है।",
        ...
        "how_to_apply_ta": "பருவ கட்-ஆஃப்க்கு முன் அருகிலுள்ள தமிழ்நாடு தோட்டக்கலை துறை அலுவலகத்தில் அல்லது உங்கள் கூட்டுறவு வங்கி மூலம் விண்ணப்பிக்கவும்.",
        "how_to_apply_hi": "मौसम कट-ऑफ से पहले निकटतम तमिलनाडु बागवानी विभाग कार्यालय या अपने सहकारी बैंक के माध्यम से आवेदन करें।",
...
def scheme_field(scheme: dict, field: str, lang: str) -> str:
    """Return a scheme's content field in the requested language.
    Each scheme can optionally carry _ta and _hi variants for direct translation;
    otherwise falls back to Google Translate via tr()."""
    ta_key = f"{field}_ta"
    hi_key = f"{field}_hi"
    if lang == "TA" and ta_key in scheme:
        return scheme[ta_key]
    if lang == "HI" and hi_key in scheme:
        return scheme[hi_key]
    en_text = scheme.get(field, "")
    if lang == "EN":
        return en_text
...
def help_farmer(phone: str) -> str:
    ...
    if lang == "TA":
        return (
            "╔══════════════════════════╗\n║  🌾 விவசாயி உதவி         ║\n╚══════════════════════════╝\n\n"
            "📅 *இன்று* — தினசரி சுருக்கம்\n📋 *வேலை போடு* — புதிய வேலை போடுங்கள்\n"
            "📂 *என் வேலைகள்* — உங்கள் வேலைகளை பாருங்கள்\n👥 *என் தொழிலாளர்கள்* — ஏற்றுக்கொண்ட / முடிந்த வேலைகள்\n"
            "✅ *வேலை முடிந்தது [id]* — வேலை முடிந்தது என்று குறிக்கவும்\n   உதாரணம்: வேலை முடிந்தது 12\n"
            "🔁 *மீண்டும் அழை [id]* — முன்பு வேலை செய்தவரை மீண்டும் அழையுங்கள்\n   உதாரணம்: மீண்டும் அழை 12\n"
            "❌ *ரத்து [id]* — வேலையை ரத்து செய்யுங்கள்\n   உதாரணம்: ரத்து 7\n"
            "⭐ *மதிப்பிடு [id] [1-5]* — தொழிலாளரை மதிப்பிடுங்கள்\n   உதாரணம்: மதிப்பிடு 12 5\n"
            "⚠️ *வரவில்லை [id]* — வராத தொழிலாளரை புகார் செய்யுங்கள்\n"
            "🚜 *உபகரணம் வாடகை* — உபகரணங்களை வாடகைக்கு போடுங்கள்\n"
            "🔧 *என் உபகரணம்* — உங்கள் உபகரண பட்டியல்\n"
            "🏛️ *திட்டங்கள்* — அரசு திட்டங்கள்\n🪪 *என் சுயவிவரம்* — உங்கள் சுயவிவரம்\n"
            "🌐 *மொழி* — மொழி மாற்றவும்\n\nஉதவி என்று அனுப்பினால் இந்த பட்டியல் எப்போதும் வரும்."
        )
    if lang == "HI":
        return (
            "╔══════════════════════════╗\n║  🌾 किसान सहायता          ║\n╚══════════════════════════╝\n\n"
            "📅 *आज* — आज का सारांश\n📋 *नौकरी पोस्ट करें* — नई नौकरी पोस्ट करें\n"
            "📂 *मेरी नौकरियाँ* — अपनी नौकरियाँ देखें\n👥 *मेरे मजदूर* — स्वीकृत/पूर्ण नौकरियाँ\n"
            "✅ *काम पूरा [id]* — काम पूरा होने पर मार्क करें\n   उदाहरण: काम पूरा 12\n"
            "🔁 *दोबारा बुलाएँ [id]* — पुराने मजदूर को दोबारा बुलाएँ\n   उदाहरण: दोबारा बुलाएँ 12\n"
            "❌ *रद्द करें [id]* — नौकरी रद्द करें\n   उदाहरण: रद्द करें 7\n"
            "⭐ *रेट करें [id] [1-5]* — मजदूर को रेट करें\n   उदाहरण: रेट करें 12 5\n"
            "⚠️ *नहीं आए [id]* — नहीं आने की रिपोर्ट करें\n"
            "🚜 *उपकरण किराया* — उपकरण किराए पर दें\n🔧 *मेरे उपकरण* — अपने उपकरण देखें\n"
            "🏛️ *योजनाएँ* — सरकारी योजनाएँ\n🪪 *मेरी प्रोफ़ाइल* — अपनी प्रोफ़ाइल देखें\n"
            "🌐 *भाषा* — भाषा बदलें\n\nसहायता भेजने पर यह सूची कभी भी देख सकते हैं।"
        )
    return (
        "╔══════════════════════════╗\n║  🌾 FARMER HELP           ║\n╚══════════════════════════╝\n\n"
...
def help_labourer(phone: str) -> str:
    ...
    if lang == "TA":
        return (
            "╔══════════════════════════╗\n║  👷 தொழிலாளர் உதவி       ║\n╚══════════════════════════╝\n\n"
            "📅 *இன்று* — தினசரி சுருக்கம்\n🔍 *வேலை பார்* — அருகிலுள்ள வேலைகளை பாருங்கள்\n"
            "✅ *உறுதிப்படுத்து [id]* — வேலையை ஏற்றுக்கொள்ளுங்கள்\n   உதாரணம்: உறுதிப்படுத்து 3\n"
            "👨‍🌾 *என் விவசாயிகள்* — ஏற்றுக்கொண்ட / முடிந்த வேலைகள்\n"
            "📜 *வேலை வரலாறு* — கடந்த வேலைகளின் வரலாறு\n📊 *என் நாட்கள்* — MGNREGA நாள் கணக்கு\n"
            "⭐ *மதிப்பிடு [id] [1-5]* — விவசாயியை மதிப்பிடுங்கள்\n   உதாரணம்: மதிப்பிடு 12 4\n"
            "🚜 *உபகரணம் பார்* — வாடகை உபகரணங்களை பாருங்கள்\n"
            "🔖 *உபகரணம் பதிவு [id]* — உபகரணம் பதிவு செய்யுங்கள்\n"
            "🏛️ *திட்டங்கள்* — அரசு திட்டங்கள்\n🛠️ *திறன் மாற்று* — உங்கள் திறனை மாற்றுங்கள்\n"
            "🪪 *என் சுயவிவரம்* — உங்கள் சுயவிவரம்\n🌐 *மொழி* — மொழி மாற்றவும்\n\n"
            "உதவி என்று அனுப்பினால் இந்த பட்டியல் எப்போதும் வரும்."
        )
    if lang == "HI":
        return (
            "╔══════════════════════════╗\n║  👷 मजदूर सहायता          ║\n╚══════════════════════════╝\n\n"
            "📅 *आज* — आज का सारांश\n🔍 *नौकरियाँ देखें* — पास की नौकरियाँ देखें\n"
            "✅ *स्वीकार करें [id]* — नौकरी स्वीकार करें\n   उदाहरण: स्वीकार करें 3\n"
            "👨‍🌾 *मेरे किसान* — स्वीकृत/पूर्ण नौकरियाँ\n"
            "📜 *नौकरी इतिहास* — पुरानी नौकरियाँ\n📊 *मेरे दिन* — MGNREGA दिन गिनती\n"
            "⭐ *रेट करें [id] [1-5]* — किसान को रेट करें\n   उदाहरण: रेट करें 12 4\n"
            "🚜 *उपकरण देखें* — किराए के उपकरण देखें\n🔖 *उपकरण बुक करें [id]* — उपकरण बुक करें\n"
            "🏛️ *योजनाएँ* — सरकारी योजनाएँ\n🛠️ *कौशल बदलें* — अपना कौशल बदलें\n"
            "🪪 *मेरी प्रोफ़ाइल* — अपनी प्रोफ़ाइल देखें\n🌐 *भाषा* — भाषा बदलें\n\n"
            "सहायता भेजने पर यह सूची कभी भी देख सकते हैं।"
        )
    return (
...
def farmer_menu(name: str, phone: str = "") -> str:
    ...
    if lang == "TA":
        return (
            ...
            f"╔══════════════════════╗\n║  🌾 விவசாயி மெனு      ║\n╚══════════════════════╝\n\n"
            f"📅 இன்று — தினசரி சுருக்கம்\n📋 வேலை போடு — புதிய வேலை போடுங்கள்\n"
            f"📂 என் வேலைகள் — உங்கள் வேலைகள்\n👥 என் தொழிலாளர்கள் — தொழிலாளர் பட்டியல்\n"
            f"✅ வேலை முடிந்தது [id] — வேலை முடிந்தது\n🔁 மீண்டும் அழை [id] — மீண்டும் அழையுங்கள்\n"
            f"🚜 உபகரணம் வாடகை — உபகரணம் வாடகை\n🔧 என் உபகரணம் — உங்கள் உபகரணங்கள்\n"
            f"🏛️ திட்டங்கள் — அரசு திட்டங்கள்\n🪪 என் சுயவிவரம் — சுயவிவரம்\n"
            f"🌐 மொழி — மொழி மாற்றவும்\n\n💡 உதவி என்று அனுப்பி முழு விவரம் பெறுங்கள்."
        )
    if lang == "HI":
        return (
            ...
            f"╔══════════════════════╗\n║  🌾 किसान मेनू         ║\n╚══════════════════════╝\n\n"
            f"📅 आज — आज का सारांश\n📋 नौकरी पोस्ट करें — नई नौकरी पोस्ट करें\n"
            f"📂 मेरी नौकरियाँ — अपनी नौकरियाँ देखें\n👥 मेरे मजदूर — मजदूरों की सूची\n"
            f"✅ काम पूरा [id] — काम पूरा मार्क करें\n🔁 दोबारा बुलाएँ [id] — दोबारा बुलाएँ\n"
            f"🚜 उपकरण किराया — उपकरण किराए पर दें\n🔧 मेरे उपकरण — अपने उपकरण देखें\n"
            f"🏛️ योजनाएँ — सरकारी योजनाएँ\n🪪 मेरी प्रोफ़ाइल — प्रोफ़ाइल देखें\n"
            f"🌐 भाषा — भाषा बदलें\n\n💡 सहायता भेजें — पूरी कमांड सूची देखें।"
        )
    return (
...
def labourer_menu(name: str, phone: str = "") -> str:
    ...
    if lang == "TA":
        return (
            f"வணக்கம் {name}! 👋 இன்று என்ன உதவி வேண்டும்?\n\n"
            f"╔══════════════════════╗\n║  👷 தொழிலாளர் மெனு   ║\n╚══════════════════════╝\n\n"
            f"📅 இன்று — தினசரி சுருக்கம்\n🔍 வேலை பார் — அருகிலுள்ள வேலைகள்\n"
            f"👨‍🌾 என் விவசாயிகள் — விவசாயி பட்டியல்\n📜 வேலை வரலாறு — கடந்த வேலைகள்\n"
            f"📊 என் நாட்கள் — MGNREGA நாள் கணக்கு\n🚜 உபகரணம் பார் — உபகரணங்கள்\n"
            f"🏛️ திட்டங்கள் — அரசு திட்டங்கள்\n🛠️ திறன் மாற்று — திறன் மாற்று\n"
            f"🪪 என் சுயவிவரம் — சுயவிவரம்\n🌐 மொழி — மொழி மாற்றவும்\n\n💡 உதவி என்று அனுப்பி முழு விவரம் பெறுங்கள்."
        )
    if lang == "HI":
        return (
            f"नमस्ते {name}! 👋 आज कैसे मदद करूँ?\n\n"
            f"╔══════════════════════╗\n║  👷 मजदूर मेनू         ║\n╚══════════════════════╝\n\n"
            f"📅 आज — आज का सारांश\n🔍 नौकरियाँ देखें — पास की नौकरियाँ\n"
            f"👨‍🌾 मेरे किसान — किसानों की सूची\n📜 नौकरी इतिहास — पुरानी नौकरियाँ\n"
            f"📊 मेरे दिन — MGNREGA दिन गिनती\n🚜 उपकरण देखें — उपकरण देखें\n"
            f"🏛️ योजनाएँ — सरकारी योजनाएँ\n🛠️ कौशल बदलें — कौशल बदलें\n"
            f"🪪 मेरी प्रोफ़ाइल — प्रोफ़ाइल देखें\n🌐 भाषा — भाषा बदलें\n\n💡 सहायता भेजें — पूरी कमांड सूची देखें।"
        )
    return (
        f"Hello {name}! 👋 How can I help you today?\n\n"
        f"╔══════════════════════╗\n║  👷 LABOURER MENU    ║\n╚══════════════════════╝\n\n"
...
def handle_message(phone: str, raw_body: str) -> str:
    ...
    # Translate Tamil/Hindi commands to English canonical before processing
    raw_body = normalize_command(raw_body)
